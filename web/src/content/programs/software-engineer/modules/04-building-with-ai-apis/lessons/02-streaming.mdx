...
*Inspired by Anthropic's ["Building with the Claude API"](https://claude.com/resources/courses). The TextDecoder flush bug is a real one we fixed across four streaming consumers in this project.*
